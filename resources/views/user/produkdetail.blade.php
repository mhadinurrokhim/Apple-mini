              ...
              <div class="col-12 col-lg-6">
                <div class="d-flex flex-column justify-content-between h-100">
                  <div class="">
                    ...
                    <h3 style="display: block; overflow-wrap: break-word; word-wrap: break-word;" class="mb-3 lh-sm">{{ ucfirst($detail->nama_produk) }}</h3>
                    <div class="d-flex flex-wrap align-items-center">
                      <h1>Rp.{{ number_format($detail->harga, 0, ',', '.') }}</h1>
                    </div>
                    <p class="@if ($detail->stok <= 0) text-danger fw-semi-bold fs-1 mb-2 @elseif ($detail->stok <= 10) text-warning fw-semi-bold fs-1 mb-2 @else text-success fw-semi-bold fs-1 mb-2 @endif">
                        Stock {{ $detail->stok }}
                    </p>
                    <p class="mb-2 text-800"><strong class="text-1000">Description:</strong>
                        <p class="mb-2 text-800">
                            <strong class="text-1000" style="display: block; overflow-wrap: break-word; word-wrap: break-word;">
