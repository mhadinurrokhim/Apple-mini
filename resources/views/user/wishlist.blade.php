                ...
                <div class="table-responsive scrollbar">
                    <table class="table fs--1 mb-0">
                        ...
                        <tbody class="list" id="profile-wishlist-table-body">
                                        ...
                                        <div class="d-flex justify-content-end ms-2">
                                            ...
                                            <form action="{{ route('shop.order', $produk->id) }}" method="POST"
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <div class="input-group input-group-sm flex-nowrap me-3"
                            ...
                            @endforeach
                        @else
                            <div class="border-y mt-3" id="productWishlistTable"
                                data-list='{"valueNames":["products","color","size","price","quantity","total"],"page":5,"pagination":true}'>
                                <div class="table-responsive scrollbar">
                                    <table class="table fs--1 mb-0">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="sort white-space-nowrap align-middle"
                                                    scope="col"style="width:30%; min-width:250px;">PRODUCTS</th>
                                                <th class="sort align-middle text-center" scope="col" style="width:16%;">
                                                    CATEGORY</th>
