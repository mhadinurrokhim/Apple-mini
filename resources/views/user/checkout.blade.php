                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    <div class="d-flex align-items-end">
                                        <h3 class="mb-0 me-3">Shipping Details</h3><a href="{{ route('profil') }}"
                                            class="btn btn-link p-0" type="button">Edit</a>
                                    </div>
                            ...
                            <div class="card-body">
                                ...
                                <form action="{{ route('bayar') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <select class="form-select mb-3 @error('metode_pengiriman') is-invalid @enderror"
                                            name="metode_pengiriman">
                                            <option value="" disabled {{ old('metode_pengiriman') ? '' : 'selected' }}>Select Shipper</option>
                                            @foreach ($pengiriman as $item)
                                                <option value="{{ $item->nama_kurir }}" {{ old('metode_pengiriman') == $item->nama_kurir ? 'selected' : '' }}>{{ $item->nama_kurir }}</option>
                                            @endforeach
                                        </select>
                                            ...
                                            <div class="row align-items-center mb-2 g-3">
                                                <div class="col-8 col-md-7 col-lg-8">
                                                    <div class="d-flex align-items-center"><img class="me-2 ms-1"
                                                            src="{{ asset('storage/Product/' . $checkout->produk->path_produk) }}"
                                                            width="40" alt="" />
                                                        <h6 class="fw-semi-bold text-1000 lh-base">
                                                            <input type="hidden" name="detail_pesanan[]"
                                                                value="{{ $checkout->id }}">
                                                            {{ Str::limit($checkout->produk->nama_produk, 20, $end = '...') }}
                                                        </h6>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-2 ps-0">
                                                    <h5 class="fs--2 mb-0">
                                                        {{ 'Rp. ' . number_format($checkout->total, 0, ',', '.') }}</h5>
                                                </div>
                                            </div>
                    ...
                    <tr>
                        <td colspan="8" class="text-center py-4">
                            <div
                                ...
                                <h3 class="mb-3">No Products in the checkout. Please add products to your cart before
                                    proceeding.</h3>
                            </div>
                        </td>
                    </tr>
