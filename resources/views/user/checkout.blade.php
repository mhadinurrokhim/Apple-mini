              ...
              <div class="mb-3" id="ewalletInput" style="display: none;">
                ...
                <select name="tujuan_ewallet" id="tujuan_ewallet" class="form-control">
                  ...
                  @forelse ($wallet as $data)
                    <option value="{{ $data->tujuan }}">{{ $data->tujuan_ewallet }}</option>
                  @empty
                ...
                @foreach ($wallet as $data)
                  @php
                    $hadi = strlen($data->keterangan_ewallet);
                  @endphp
                  @if ($hadi >= 20)
                    <p class="" name="keterangan_ewallet" value="{{ $data->keterangan_ewallet }}" id="{{ $data->tujuan_ewallet }}">
                      <a href="{{ asset('storage/product/' . $data->keterangan_ewallet) }}" data-toggle="lightbox">
                        <img src="{{ asset('storage/product/' . $data->keterangan_ewallet) }}"
              ...
              <div class="mb-3" id="bankInput" style="display: none;">
                ...
                <select name="tujuan_bank" id="tujuan_bank" class="form-control">
                  ...
                  @forelse ($bank as $data)
                    <option value="{{ $data->tujuan }}">{{ $data->tujuan_bank }}</option>
                  @empty
                ...
                @foreach ($bank as $data)
                  ...
                  @if ($hadi >= 20)
                  @else
                    <input type="text" name="keterangan_bank" value="{{ $data->keterangan_bank }}"
                      id="{{ $data->tujuan_bank }}" class="form-control" readonly disabled>
                  @endif
                @endforeach
              </div>
              <div class="">
                  ...
                  <div class="ms-n2">
                    <div class="row align-items-center mb-2 g-3">
                      ...
                      <div class="col-2 ps-0">
                        <h5 class="fs--2 mb-0">{{ 'Rp. ' . number_format($checkout->totalharga, 0, ',', '.') }}</h5>
                      </div>
                    </div>
