                                ...
                                <table class="table fs--1 mb-0 border-top border-200">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="sort align-middle" scope="col" style="width:80px;">CATEGORY
                                            </th>
                                            <th class="sort align-middle text-end" scope="col" style="width:300px;">
                                                PRICE</th>
                                            <th class="sort align-middle ps-5" scope="col" style="width:200px;">
                                                QUANTITY</th>
                                            <th class="sort align-middle text-end" scope="col" style="width:250px;">
                                                TOTAL</th>
                                    ...
                                    <tbody class="list" id="cart-table-body">
                                        ...
                                        <tr class="cart-table-row btn-reveal-trigger">
                                            <td class="align-middle white-space-nowrap py-0"><a
                                                ...
                                                src="{{ asset($pesanan->produk->path_produk) }}" alt="{{ $pesanan->produk->nama_produk }}"
                                                        width="53" /></a></td>
                                            <td class="products align-middle"><a class="fw-semi-bold mb-0 line-clamp-2"
                                                    href="#">{{ ucfirst($pesanan->produk->nama_produk) }}</a></td>
                                            <td class="color align-middle white-space-nowrap fs--1 text-900">{{ ucfirst($pesanan->kategori) }}</td>
                                            ...
                                            <td class="quantity align-middle fs-0 ps-5">
                                                <div class="input-group input-group-sm flex-nowrap"
                                                    data-quantity="data-quantity"><button class="btn btn-sm px-2"
                                                        ...
                                                        type="number" min="1" value="{{ $pesanan->jumlah }}" name="jumlah[{{ $pesanan->id }}]"
        ...
        <div class="container-small">
            <div class="row justify-content-between gy-4">
                <div class="col-12 col-lg-4">
                    ...
                    <p class="text-700 mb-1 fw-semi-bold lh-sm fs--1">Phoenix is an admin dashboard template with
                ...
                <div class="col-6 col-md-auto">
                    ...
                    <div class="d-flex flex-column"><a class="text-700 fw-semi-bold fs--1 mb-1"
                            href="#!">Blogs</a><a class="mb-1 fw-semi-bold fs--1 d-flex" href="#!"><span
                                class="fab fa-facebook-square text-primary me-2 fs-0"></span><span
                                class="text-800">Facebook</span></a><a class="mb-1 fw-semi-bold fs--1 d-flex"
                            href="#!"><span class="fab fa-twitter-square text-info me-2 fs-0"></span><span
