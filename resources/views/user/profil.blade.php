                            ...
                            <div class="card-body">
                                ...
                                <div class="border-top border-dashed border-300 pt-2">
                                    <div class="row flex-between-center mb-2">
                                        <div class="col-auto">
                                            <h5 class="text-1000 mb-0">Address : <p class="text-1000">{{ $user->address }}
                                                </p>
                                            </h5>
                                        </div>
                                    </div>
                                    <div class="row flex-between-center mb-2">
                                        <div class="col-auto">
                                            <h5 class="text-1000 mb-0">Email : <p class="text-800">{{ Auth::user()->email }}
                                                </p>
                                            </h5>
                                        </div>
                                    </div>
                                    <div class="row flex-between-center">
                                        <div class="col-auto">
                                            <h5 class="text-1000 mb-0">Phone : <p class="text-800">+{{ $user->telp }}</p>
                                            </h5>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <ul class="nav nav-underline flex-nowrap mb-3 pb-1" id="myTab" role="tablist">
                                <li class="nav-item me-3"><a class="nav-link text-nowrap active" id="orders-tab"
                                        ...
                                        aria-selected="true"><span class="fas fa-shopping-cart me-2"></span>Orders <span
                                            class="text-700 fw-normal"> (35)</span></a></li>
