              ...
              <div class="col-12 mx-auto col-md-6 d-flex justify-content-between">
                ...
                <div class="d-flex align-items-center mt-3" style="margin-left: 150px;">
                  <a href="{{ route('login') }}"
                    ...
                    <button type="button" class="btn btn-outline-primary me-2" style="width: 100px;"
        ...
        <div class=" ">
          <div class="row g-3 mb-9">
            <div class="col-12">
              <div class="whooping-banner w-100 rounded-0 overflow-hidden">
                <div class="bg-holder z-index--1 product-bg"
                  style="background-image: url(/assets/img/benner1.png); background-size: cover;"></div>
                <div class="banner-text light">
                  <h2 class="text-warning-300 fw-bolder fs-lg-5 fs-xxl-6">iPhone <span class="gradient-text">15
                    </span>Pro </h2>
            ...
            <div class="col-12">
              <div class="whooping-banner w-100 rounded-0 overflow-hidden">
                <div class="bg-holder z-index--1 product-bg"
                  style="background-image: url(/assets/img/benner2.png); background-size: cover;"></div>
            ...
            <div class="col-12">
              <div class="whooping-banner w-100 rounded-0 overflow-hidden">
                <div class="bg-holder z-index--1 product-bg"
                  style="background-image: url(/assets/img/benner3.png); background-size: cover;"></div>
                <div class="banner-text light">
            ...
            <div class="col-12 col-xl-6">
              <div class="gift-items-banner w-100 rounded-0 overflow-hidden">
                <div class="bg-holder z-index--1 banner-bg" style="background-image:url(/assets/img/oalah1.png);">
                </div>
                <!--/.bg-holder-->
            ...
            <div class="col-12 col-xl-6">
              <div class="best-in-market-banner d-flex h-100 px-4 px-sm-7 py-5 px-md-11 rounded-0 overflow-hidden">
                <div class="bg-holder z-index--1 banner-bg" style="background-image:url(/assets/img/oalah2.png);">
                </div>
                <!--/.bg-holder-->
            ...
            <div class="col-12 col-xl-6">
              <div class="gift-items-banner w-100 rounded-0 overflow-hidden">
                <div class="bg-holder z-index--1 banner-bg" style="background-image:url(/assets/img/oalah3.png);">
                </div>
                <!--/.bg-holder-->
                <div class="banner-text text-md-center light">
                </div>
            ...
            <div class="col-12 col-xl-6">
              <div class="best-in-market-banner d-flex h-100 px-4 px-sm-7 py-5 px-md-11 rounded-0 overflow-hidden">
                <div class="bg-holder z-index--1 banner-bg" style="background-image:url(/assets/img/oalah4.png);">
                </div>
                <!--/.bg-holder-->
                <div class="row align-items-center w-sm-100">
                  <div class="col-8">
        ...
        <div class="row justify-content-between gy-4">
          ...
          <div class="col-6 col-md-auto">
            ...
            <div class="d-flex flex-column"><a class="text-700 fw-semi-bold fs--1 mb-1" href="#!">Jalan Ijen
                No. 123 Kota Malang, Indonesia</a><a class="mb-1 fw-semi-bold fs--1 d-flex" href="#!"><span
                  class="fab fa-facebook-square text-primary me-2 fs-0"></span><span class="text-800">+62
