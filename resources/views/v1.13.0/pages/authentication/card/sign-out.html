...
<!-- Mirrored from prium.github.io/phoenix/v1.13.0/pages/authentication/card/sign-out.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 27 Nov 2023 13:02:10 GMT -->
                    ...
                    <div class="auth-form-box">
                      <div class="text-center mb-6 mx-auto"><img class="mb-7 d-dark-none" src="../../../assets/img/spot-illustrations/1.png" alt="phoenix" /><img class="mb-7 d-light-none" src="../../../assets/img/spot-illustrations/dark_1.png" alt="phoenix" />
                        <div class="mb-6">
                          ...
                          <p class="text-700">Thanks for using Phoenix. <br class="d-lg-none" />You are now successfully <br class="d-sm-none" />signed out.</p>
                        </div>
