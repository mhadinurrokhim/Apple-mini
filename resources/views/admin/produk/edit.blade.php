      ...
      <div class="row g-5">
        <div class="col-12 col-xl-8">
          <h4 class="mb-3">Product Title</h4><input class="form-control mb-5" type="text" name="nama_produk"
            value="{{ old('name', $produk->nama_produk) }}" placeholder="Write title here..." />
          <div class="mb-6">
              ...
              <div class="card mb-3">
                <div class="card-body">
                  ...
                  <div class="row gx-3">
                    ...
                    <div class="col-12 col-sm-6 col-xl-12">
                      <div class="mb-4">
                        <h5 class="mb-2 text-1000">stock</h5><input class="form-control mb-xl-3" type="number"
                          name="stok" value="{{ old('name', $produk->stok) }}" placeholder="stock" />
                      </div>
                    </div>
                    <div class="col-12 col-sm-6 col-xl-12">
                      <div class="mb-4">
                        <h5 class="mb-2 text-1000">price</h5><input class="form-control mb-xl-3" type="number"
                          name="harga" value="{{ old('name', $produk->harga) }}" placeholder="price" />
                      </div>
                    </div>
                  </div>
                </div>
