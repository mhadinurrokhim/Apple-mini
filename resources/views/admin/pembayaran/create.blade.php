        ...
        <form method="POST" action="{{ route('pembayaran.store') }}" class="mb-9">
            ...
            <div class="row g-3 flex-between-end mb-5">
                ...
                <div class="col-auto"><button class="btn btn-phoenix-secondary me-2 mb-2 mb-sm-0"
                        ...
                        type="submit">Publish category</button></div>
            </div>
            <div class="row g-5">
                <div class="col-12 col-xl-12">
                    <h4 class="mb-3">Payment Title</h4><input
                        class="form-control @error('metode_pembayaran') is-invalid @enderror" name="metode_pembayaran"
                        value="{{ old('metode_pembayaran') }}" type="text" placeholder="Write title here..." />
