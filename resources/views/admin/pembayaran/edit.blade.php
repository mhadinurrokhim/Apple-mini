...
@section('content')
    ...
    <div class="content">
      ...
      <form action="{{ route('pembayaran.update', $pembayaran->id) }}" method="POST" class="mb-9">
        @method('PUT')
        @csrf

        <div class="row g-3 flex-between-end mb-5">
          <div class="col-auto">
            <h2 class="mb-2">Edit a payment</h2>
        ...
        <div class="row g-5">
          <div class="col-12 col-xl-12">
            <h4 class="mb-3">Payment Title</h4><input class="form-control @error('metode_pembayaran') is-invalid @enderror" name="metode_pembayaran" value="{{ $pembayaran->metode_pembayaran }}" type="text" placeholder="Write title here..." />
