                ...
                <div class="dropdown-menu border border-300 font-base start-0 py-0 overflow-hidden w-100">
                  <div class="scrollbar-overlay" style="max-height: 30rem;">
                    <div class="list pb-3">
                      ...
                      <div class="py-2"><a class="dropdown-item" href="{{ route('user.product_details') }}">
                        ...
                        <a class="dropdown-item" href="{{ route('user.product_details') }}">
                          <div class="d-flex align-items-center">
                      ...
                      <div class="py-2"><a class="dropdown-item py-2 d-flex align-items-center" href="{{ route('user.product_details') }}">
                        ...
                        <a class="dropdown-item py-2 d-flex align-items-center" href="{{ route('user.product_details') }}">
                ...
                <table class="table fs--1 mb-0">
                  ...
                  <tbody class="list" id="products-table-body">
                    <tr class="position-static">
                      ...
                      <td class="align-middle white-space-nowrap py-0"><a class="d-block border rounded-2" href="{{ route('user.product_details') }}"><img src="../../../assets/img/products/1.png" alt="" width="53" /></a></td>
                      <td class="product align-middle ps-4"><a class="fw-semi-bold line-clamp-3 mb-0" href="{{ route('user.product_details') }}">Fitbit Sense Advanced Smartwatch with Tools for Heart Health, Stress Management &amp; Skin Temperature Trends, Carbon/Graphite, One Size (S &amp; ...</a></td>
                    ...
                    <tr class="position-static">
                      ...
                      <td class="align-middle white-space-nowrap py-0"><a class="d-block border rounded-2" href="{{ route('user.product_details') }}"><img src="../../../assets/img/products/2.png" alt="" width="53" /></a></td>
                      <td class="product align-middle ps-4"><a class="fw-semi-bold line-clamp-3 mb-0" href="{{ route('user.product_details') }}">iPhone 13 pro max-Pacific Blue-128GB storage</a></td>
                    ...
                    <tr class="position-static">
                      ...
                      <td class="align-middle white-space-nowrap py-0"><a class="d-block border rounded-2" href="{{ route('user.product_details') }}"><img src="../../../assets/img/products/3.png" alt="" width="53" /></a></td>
                      <td class="product align-middle ps-4"><a class="fw-semi-bold line-clamp-3 mb-0" href="{{ route('user.product_details') }}">Apple MacBook Pro 13 inch-M1-8/256GB-space</a></td>
                    ...
                    <tr class="position-static">
                      ...
                      <td class="align-middle white-space-nowrap py-0"><a class="d-block border rounded-2" href="{{ route('user.product_details') }}"><img src="../../../assets/img/products/4.png" alt="" width="53" /></a></td>
                      <td class="product align-middle ps-4"><a class="fw-semi-bold line-clamp-3 mb-0" href="{{ route('user.product_details') }}">Apple iMac 24&quot; 4K Retina Display M1 8 Core CPU...</a></td>
                    ...
                    <tr class="position-static">
                      ...
                      <td class="align-middle white-space-nowrap py-0"><a class="d-block border rounded-2" href="{{ route('user.product_details') }}"><img src="../../../assets/img/products/5.png" alt="" width="53" /></a></td>
                      <td class="product align-middle ps-4"><a class="fw-semi-bold line-clamp-3 mb-0" href="{{ route('user.product_details') }}">Razer Kraken v3 x Wired 7.1 Surroung Sound Gaming headset</a></td>
                    ...
                    <tr class="position-static">
                      ...
                      <td class="align-middle white-space-nowrap py-0"><a class="d-block border rounded-2" href="{{ route('user.product_details') }}"><img src="../../../assets/img/products/6.png" alt="" width="53" /></a></td>
                      <td class="product align-middle ps-4"><a class="fw-semi-bold line-clamp-3 mb-0" href="{{ route('user.product_details') }}">PlayStation 5 DualSense Wireless Controller</a></td>
                    ...
                    <tr class="position-static">
                      ...
                      <td class="align-middle white-space-nowrap py-0"><a class="d-block border rounded-2" href="{{ route('user.product_details') }}"><img src="../../../assets/img/products/7.png" alt="" width="53" /></a></td>
                      <td class="product align-middle ps-4"><a class="fw-semi-bold line-clamp-3 mb-0" href="{{ route('user.product_details') }}">2021 Apple 12.9-inch iPad Pro (Wi‑Fi, 128GB) - Space Gray</a></td>
                    ...
                    <tr class="position-static">
                      ...
                      <td class="align-middle white-space-nowrap py-0"><a class="d-block border rounded-2" href="{{ route('user.product_details') }}"><img src="../../../assets/img/products/8.png" alt="" width="53" /></a></td>
                      <td class="product align-middle ps-4"><a class="fw-semi-bold line-clamp-3 mb-0" href="{{ route('user.product_details') }}">Amazon Basics Matte Black Wired Keyboard - US Layout (QWERTY)</a></td>
                    ...
                    <tr class="position-static">
                      ...
                      <td class="align-middle white-space-nowrap py-0"><a class="d-block border rounded-2" href="{{ route('user.product_details') }}"><img src="../../../assets/img/products/10.png" alt="" width="53" /></a></td>
                      <td class="product align-middle ps-4"><a class="fw-semi-bold line-clamp-3 mb-0" href="{{ route('user.product_details') }}">Apple Magic Mouse (Wireless, Rechargable) - Silver</a></td>
                    ...
                    <tr class="position-static">
                      ...
                      <td class="align-middle white-space-nowrap py-0"><a class="d-block border rounded-2" href="{{ route('user.product_details') }}"><img src="../../../assets/img/products/12.png" alt="" width="53" /></a></td>
                      <td class="product align-middle ps-4"><a class="fw-semi-bold line-clamp-3 mb-0" href="{{ route('user.product_details') }}">HORI Racing Wheel Apex for PlayStation 4_3, and PC</a></td>
                    ...
                    <tr class="position-static">
                      ...
                      <td class="align-middle white-space-nowrap py-0"><a class="d-block border rounded-2" href="{{ route('user.product_details') }}"><img src="../../../assets/img/products/21.png" alt="" width="53" /></a></td>
                      <td class="product align-middle ps-4"><a class="fw-semi-bold line-clamp-3 mb-0" href="{{ route('user.product_details') }}">Apple Pencil (2nd Generation)</a></td>
                    ...
                    <tr class="position-static">
                      ...
                      <td class="align-middle white-space-nowrap py-0"><a class="d-block border rounded-2" href="{{ route('user.product_details') }}"><img src="../../../assets/img/products/16.png" alt="" width="53" /></a></td>
                      <td class="product align-middle ps-4"><a class="fw-semi-bold line-clamp-3 mb-0" href="{{ route('user.product_details') }}">Apple AirPods (2nd Generation)</a></td>
                    ...
                    <tr class="position-static">
                      ...
                      <td class="align-middle white-space-nowrap py-0"><a class="d-block border rounded-2" href="{{ route('user.product_details') }}"><img src="../../../assets/img/products/17.png" alt="" width="53" /></a></td>
                      <td class="product align-middle ps-4"><a class="fw-semi-bold line-clamp-3 mb-0" href="{{ route('user.product_details') }}">Xbox Series S</a></td>
                    ...
                    <tr class="position-static">
                      ...
                      <td class="align-middle white-space-nowrap py-0"><a class="d-block border rounded-2" href="{{ route('user.product_details') }}"><img src="../../../assets/img/products/18.png" alt="" width="53" /></a></td>
                      <td class="product align-middle ps-4"><a class="fw-semi-bold line-clamp-3 mb-0" href="{{ route('user.product_details') }}">Seagate Portable 2TB External Hard Drive Portable HDD</a></td>
                    ...
                    <tr class="position-static">
                      ...
                      <td class="align-middle white-space-nowrap py-0"><a class="d-block border rounded-2" href="{{ route('user.product_details') }}"><img src="../../../assets/img/products/19.png" alt="" width="53" /></a></td>
                      <td class="product align-middle ps-4"><a class="fw-semi-bold line-clamp-3 mb-0" href="{{ route('user.product_details') }}">Intel Core i9-11900K Desktop Processor 8 Cores up to 5.3 GHz Unlocked</a></td>
                    ...
                    <tr class="position-static">
                      ...
                      <td class="align-middle white-space-nowrap py-0"><a class="d-block border rounded-2" href="{{ route('user.product_details') }}"><img src="../../../assets/img/products/20.png" alt="" width="53" /></a></td>
                      <td class="product align-middle ps-4"><a class="fw-semi-bold line-clamp-3 mb-0" href="{{ route('user.product_details') }}">ASUS TUF Gaming F15 Gaming Laptop</a></td>
