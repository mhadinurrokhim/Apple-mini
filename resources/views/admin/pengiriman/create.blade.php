...
@include('Asset.SweetAlert')
    ...
    <div class="content">
        <form method="POST" action="{{ route('pengiriman.store') }}" class="mb-9">
            @csrf
            ...
            <div class="row g-3 flex-between-end mb-5">
                ...
                <div class="col-auto">
                    <a class="btn btn-phoenix-secondary me-2 mb-2 mb-sm-0" href="{{ route('pengiriman') }}">Discard</a>
                    <button class="btn btn-primary mb-2 mb-sm-0" type="submit">Publish Shipping</button>
                </div>
            </div>
            <div class="row g-5">
                <div class="col-12 col-xl-12">
                    <h4 class="mb-3">Shipping Title</h4>
                    <input class="form-control @error('nama_kurir') is-invalid @enderror" name="nama_kurir" value="{{ old('nama_kurir') }}" type="text" placeholder="Write title here..." />
                    @error('nama_kurir')
