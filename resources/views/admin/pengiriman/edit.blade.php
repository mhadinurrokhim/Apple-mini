...
@include('Asset.SweetAlert')
    ...
    <div class="content">
      ...
      <form action="{{ route('pengiriman.update', $pengiriman->id) }}" method="POST" class="mb-9">
        @method('PUT')
        @csrf

        <div class="row g-3 flex-between-end mb-5">
          <div class="col-auto">
            <h2 class="mb-2">Add a Shipping</h2>
            <h5 class="text-700 fw-semi-bold">Orders placed across your store</h5>
          </div>
          <div class="col-auto"><button class="btn btn-phoenix-secondary me-2 mb-2 mb-sm-0" type="button">Discard</button><button class="btn btn-primary mb-2 mb-sm-0" type="submit">Publish Shipping</button></div>
        </div>
        <div class="row g-5">
          <div class="col-12 col-xl-12">
            <h4 class="mb-3">Shipping Title</h4><input class="form-control @error('nama_kurir') is-invalid @enderror" name="nama_kurir" value="{{ $pengiriman->nama_kurir }}" type="text" placeholder="Write title here..." />
            @error('nama_kurir')
