...
<!-- Mirrored from prium.github.io/phoenix/v1.13.0/pages/authentication/card/2FA.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 27 Nov 2023 13:02:10 GMT -->
                    ...
                    <div class="auth-form-box">
                      <div class="text-center"><a class="d-flex flex-center text-decoration-none mb-4" href="../../../index.html">
                        ...
                        <form class="verification-form" data-2FA-varification="data-2FA-varification">
                          <div class="d-flex align-items-center gap-2 mb-3"><input class="form-control px-2 text-center" type="number" /><input class="form-control px-2 text-center" type="number" disabled="disabled" /><input class="form-control px-2 text-center" type="number" disabled="disabled" /><span>-</span><input class="form-control px-2 text-center" type="number" disabled="disabled" /><input class="form-control px-2 text-center" type="number" disabled="disabled" /><input class="form-control px-2 text-center" type="number" disabled="disabled" /></div>
                          <div class="form-check text-start mb-4"><input class="form-check-input" id="2fa-checkbox" type="checkbox" /><label for="2fa-checkbox">Don’t ask again on this device</label></div><Button class="btn btn-primary w-100 mb-5" type="submit">Varify</Button><a class="fs--1" href="#!">Didn’t receive the code? </a>
                        </form>
                      </div>
                    </div>
                  </div>
